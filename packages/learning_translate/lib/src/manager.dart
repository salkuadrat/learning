...
class TranslationModelManager {
  static final MethodChannel _channel = MethodChannel('LearningTranslationModelManager');
  ...
  static Future<bool> check(String translationModel) async {
    try {
      return await _channel.invokeMethod('check', <String, dynamic>{
        'model': translationModel
      });
    } on PlatformException catch(e) {
      print(e.message);
  ...
  static Future<bool> delete(String translationModel) async {
    try {
      return await _channel.invokeMethod('delete', <String, dynamic>{
        'model': translationModel
      });
    } on PlatformException catch(e) {
      print(e.message);
