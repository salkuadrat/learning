...
/**
 * LearningSelfieSegmentationPlugin
 */
public class LearningSelfieSegmentationPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private void process(@NonNull MethodCall call, @NonNull Result result) {
        ...
        if (image != null) {
            ...
            selfieSegmentation.process(image, result);
        }
    }
